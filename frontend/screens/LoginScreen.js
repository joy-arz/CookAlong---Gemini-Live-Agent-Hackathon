...
const styles = StyleSheet.create({
    ...
    forgotPasswordText: { fontFamily: 'SpaceGrotesk-Regular', color: '#A0AEC0', fontSize: 14 },

    primaryButton: { backgroundColor: '#FFFFFF', height: 60, borderRadius: 30, justifyContent: 'center', alignItems: 'center' },
